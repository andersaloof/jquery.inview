 ...
 *    - visible area calculation from https://github.com/Webmie/jquery.inview
 */
(function($) {
    ...
    if (elementsLength) {
      ...
      for (; i < elementsLength; i++) {
        ...
        if (elementOffset.top + elementSize.height > viewportOffset.top &&
          ...
          // Check if visible part of element fulfills required horizontal/vertical percentages
          if ($element.data('inview-percentage-x') || $element.data('inview-percentage-y')) {
            var percentX = parseInt($element.data('inview-percentage-x') || 0, 10) / 100;
            var percentY = parseInt($element.data('inview-percentage-y') || 0, 10) / 100;
            ...
            var visiblePercentageX = visibleWidth / elementSize.width;
